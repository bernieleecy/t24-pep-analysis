rule make_pep_rmsd_xvgs:
    ...
    params:
        prefix="runs/{folder}",
        ndx_group="r_188-208_&_Backbone",
    shell:
        """
...
rule plot_pep_rmsd_all:
    ...
    input:
        get_pep_rmsd_xvgs,
    output:
        "results/{folder}/peptide/t24_pep_backbone_rmsd.png",
    params:
        ylabel="RMSD (Å)",
        time_unit="ns",
        ymax=5,
...
rule plot_pep_rmsf:
    input:
        get_pep_rmsf_xvgs,
    output:
        "results/{folder}/peptide/t24_pep_backbone_rmsf.png",
    script:
